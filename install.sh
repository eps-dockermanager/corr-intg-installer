...
if ! curl -o compose.yml https://raw.githubusercontent.com/eps-dockermanager/corr-intg-installer/refs/heads/main/compose.yml; then
...
read -p "Enter the version to be installed e.g v12.1.10: " image_version
...
if docker compose ps | grep -q "Up"; then
  print_color 31 43 "Installation completed successfully."
else
